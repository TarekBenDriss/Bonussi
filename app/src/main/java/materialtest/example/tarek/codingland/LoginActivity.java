            ...
            public void onClick(View v) {
                ...
                t=0;
                 ...
                 final String password = mPasswordView.getText().toString();
                    ...
                    // String url="http://10.0.2.2/android/json.php";
                    String url = "http://xxx.com/codingland/getuser.php";
                                ...
                                public void onResponse(String response) {
                                    ...
                                    try
                                    {
                                        ...
                                        if(t==1) {
                                          ...
                                          else  Toast.makeText(LoginActivity.this, "erreur de login", Toast.LENGTH_SHORT).show();
                                    }
                                    catch(Exception e)
                                    {}
                                }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try
                        {
                            ...
                            Toast.makeText(LoginActivity.this, "erreur de login", Toast.LENGTH_SHORT).show();
                        }
                        catch(Exception e)
                        {}
                    }
